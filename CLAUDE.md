...
| Desktop services | `desktop/src/main/` (screenshot, activity, idle, offline, keychain, network-monitor, api-client, work-session-store, session-sync-worker, session-rules) |
