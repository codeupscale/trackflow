...
const platformDownloads = [
  { icon: Laptop, platform: "macOS", subtitle: "Download latest" },
  { icon: Monitor, platform: "Windows", subtitle: "Download latest" },
  { icon: Terminal, platform: "Linux", subtitle: "Download latest" },
];
