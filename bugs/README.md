...
| [desktop-today-total-zero-offline-after-autostop.md](desktop-today-total-zero-offline-after-autostop.md) | Desktop offline today-total display | P2 | ✅ FIXED (2026-06-22) — app showed 00:00:00 after offline sleep auto-stop though time was saved; get-timer-state returned 0 offline + stopTimer didn't accumulate session locally. Local fallback + offline accumulate |
