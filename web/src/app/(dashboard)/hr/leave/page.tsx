    ...
    return (
        <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <Button
                    nativeButton={false}
                    render={<Link href="/hr/leave/apply" />}
                >
                    ...
                    <Card>
                        <CardContent className="py-12">
                            <div className="text-center">
                                ...
                                <p className="text-sm text-muted-foreground mt-1">
                                    Click &quot;Apply for Leave&quot; to submit
                                    your first request.
                                </p>
                            </div>
                        </CardContent>
                ...
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            ...
                            {cancelTarget?.leave_type.name} request for{" "}
                            {formatDate(cancelTarget?.start_date)} to{" "}
                            {formatDate(cancelTarget?.end_date)}? This action
                            cannot be undone.
                        </DialogDescription>
                    </DialogHeader>
                    <DialogFooter>
