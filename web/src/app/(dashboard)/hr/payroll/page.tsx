...
import { CheckCircle, Loader2, Play, Plus } from "lucide-react";
...
export default function PayrollPage() {
    ...
    const [approveTarget, setApproveTarget] = useState<PayrollPeriod | null>(
        null,
    );
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                        Manage payroll periods, run payroll, and approve
                        payslips
                    </p>
                </div>
                {canRun && (
            ...
            >
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            This will calculate payslips for all employees with
                            salary assignments for the period &ldquo;
                            {runTarget?.name}&rdquo;. This may take a few
                            minutes for large teams.
                        </DialogDescription>
                    </DialogHeader>
                    <DialogFooter>
                        ...
                        <Button
                            onClick={() => {
                                if (runTarget) {
                                    runMutation.mutate(runTarget.id, {
            ...
            >
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            This will finalize all payslips for &ldquo;
                            {approveTarget?.name}&rdquo;. This action cannot be
                            undone.
                        </DialogDescription>
                    </DialogHeader>
                    <DialogFooter>
