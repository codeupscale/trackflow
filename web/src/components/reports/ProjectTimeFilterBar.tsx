...
import type { ProjectTimeFilters, ProjectTimePeriod } from '@/hooks/reports/use-project-time-report';
...
export function ProjectTimeFilterBar({ filters, onChange }: ProjectTimeFilterBarProps) {
  return (
