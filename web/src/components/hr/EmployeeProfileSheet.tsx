...
import {
    MANAGER_ROLES,
    UserCombobox,
} from "@/components/time-entries/UserCombobox";
        ...
        <Sheet open={open} onOpenChange={onOpenChange}>
            <SheetContent side="right" className="sm:max-w-xl overflow-y-auto">
                <SheetHeader>
                    ...
                    <SheetDescription>
                        Update{" "}
                        {employee?.name ? `${employee.name}'s` : "employee"}{" "}
                        profile information.
                    </SheetDescription>
                </SheetHeader>
...
function getDefaults(employee: EmployeeDetail | null): EmployeeProfileInput {
    return {
        ...
        marital_status: (employee?.marital_status ??
            null) as EmployeeProfileInput["marital_status"],
        nationality: employee?.nationality ?? null,
        blood_group: (employee?.blood_group ??
            null) as EmployeeProfileInput["blood_group"],
